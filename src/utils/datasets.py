...
class DataManager(object):
    ...
    def get_data(self):
        if self.dataset_name == 'imdb':
            ...
            if hasattr(self, 'use_folder') and self.use_folder:
                ground_truth_data = self._load_fer2013_from_folder()
            else:
    ...
    def _load_fer2013_from_folder(self):
        """Load fer2013 data from folder structure (train/class_name/*.jpg)"""
            ...
            for filename in os.listdir(emotion_folder):
                if filename.lower().endswith(('.jpg', '.jpeg', '.png')):
                    ...
                    if image is not None:
                        ...
                        faces.append(image.astype('float32'))
        ...
        print(f"Loaded {len(faces)} images from folder structure")
        return faces, emotions
